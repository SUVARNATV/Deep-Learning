...
cap=cv2.VideoCapture('/home/suvarna/Documents/open_cv_works/multiple vehicle detect and count/tf.mp4')


my_file = open("/home/suvarna/Documents/open_cv_works/multiple vehicle detect and count/coco.txt", "r")
data = my_file.read()
...
#counting truck going down
    ...
    cvzone.putTextRect(frame,f'downcar:{cdown}',(50,110),2,2)
    cvzone.putTextRect(frame,f'busup:{cbusup}',(792,43),2,2)
    cvzone.putTextRect(frame,f'busdown:{cbusdown}',(792,100),2,2)
    cvzone.putTextRect(frame,f'uptruck:{ctruckup}',(792,150),2,2)
    cvzone.putTextRect(frame,f'downtruck:{ctruckdown}',(792,250),2,2)
